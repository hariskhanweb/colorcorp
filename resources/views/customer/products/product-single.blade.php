                ...
                <form class="w-full lg:px-0 md:px-0" method="POST" action="{{ route('add.cart') }}">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        @foreach($prodattribes as $prodattrlist)
                              ...
                              <div class="w-full md:w-1/2 pl-3">
                                <div class="relative">
                                  <select name="proatt[{{$prodattrlist->attrid}}]" class="block appearance-none block w-full bg-white text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 attr_pro" onchange="getval(this);" id="grid-state" required>
...
// function getval(sel) {   
//   let selected=[];
//   $('.attr_pro :selected').each(function(){
//     if($(this).data('isprice') != 0) {
//       selected[$(this).data('price')]=$(this).data('price');
//     }
//   }).get();
//   let sum = selected.reduce(function(a, b){
//     console.log(a);
//     console.log(b);
//     return a + b;
//   }, 0);  
...
//   console.log(sum);
//   let proprice=$('#pro-sinlprice').data('price');
//   let total=parseFloat(sum+proprice).toFixed(2);
//   $('#pro-sinlprice').html('$'+total);   
// }

function getval(sel) { 
  let proprice = parseFloat($('#pro-sinlprice').data('price'));
  let total = proprice;
  $('.attr_pro :selected').each(function() {
    let selectedValue = $(this).data('price');
    if($(this).data('isprice') != 0) {
      total += selectedValue;
    }
  });
  $('#pro-sinlprice').html('$' + total.toFixed(2));
}
