...
<p>Your order on {{ env('APP_NAME') }} has been confirmed. Your order details are shown below</p>
...
<table style="width: 100%;">
  <tr>
    <td colspan="1" style="text-align: center; padding: 20px 0px;">
      <a style="background-color: #eb2d90; padding:10px; color:#fff" href="{{ asset('invoices/Invoice'.$details['orderdata']->order_number.'.pdf') }}" target="_blank" download>
        <svg class="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"></path></svg><span>Download Invoice</span>
      </a>
    </td>
  <tr>
</table>
