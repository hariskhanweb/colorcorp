...
<div class="container-fluid">
    <div class="bread-header">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{url('/').'/admin/attributes/create'}}" class="btn btn-success btn-add-new">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            ...
                                            <a href="{{url('/').'/admin/attributes/edit/'.$data->id}}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
                                                <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Edit</span>
                                            </a>
                                            <a href="{{url('/').'/admin/attributes/'.$data->id}}" title="View" class="btn btn-sm btn-warning pull-right view">
