...
<div class="container-fluid">
    <div class="bread-header">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ url('admin/categories/create') }}" class="btn btn-success btn-add-new">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            ...
                                            <a href="categories/{{ $data->id }}/edit" title="Edit" class="btn btn-sm btn-primary pull-right edit">
                                                <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Edit</span>
                                            </a>
                                            <a href="categories/{{ $data->id }}" title="View" class="btn btn-sm btn-warning pull-right view">
...
@section('javascript')
    ...
    <script>
        ...
        $('td').on('click', '.delete', function (e) {
            /*$('#delete_form')[0].action = '{{ route('voyager.'.$dataType->slug.'.destroy', '__id', 'delete') }}'.replace('__id', $(this).data('id'));*/
            var url = '{{ route('voyager.'.$dataType->slug.'.destroy', '__id', 'delete') }}'.replace('__id', $(this).data('id'));
            url = url+"/delete";
            $('#delete_form')[0].action = url;
