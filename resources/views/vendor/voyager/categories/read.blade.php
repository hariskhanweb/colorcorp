...
<div class="bread-header">
    ...
    <div class="bread-buttons">
        @can('edit', $dataTypeContent)
            @php 
              $editurl = 'admin/categories/'.$dataTypeContent->id.'/edit';
            @endphp
            <a href="{{ url($editurl) }}" class="btn btn-info">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @else
                                @include('voyager::multilingual.input-hidden-bread-read')
                                @if($row->getTranslatedAttribute('display_name')=='Parent')                            
                                    <p>{{ Helper::getParentCat($dataTypeContent->{$row->field}) }}</p>
                                @else
