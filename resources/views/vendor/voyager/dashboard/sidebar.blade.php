            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="{{ route('voyager.dashboard') }}">
                    <div class="logo-icon-container">
                        ...
                        @if($admin_logo_img == '')
                        <img src="{{ url('img/colorcorp-logo-icon.png') }}" class="admin-icon" alt="Logo Icon">
                        @else
                    ...
                    <div class="title">
                        ...
                        @if($site_logo_img == '')
                        <img src="{{ url('img/logo.png') }}" class="admin-icon" alt="Admin Logo">
                        <!-- <img src="{{ url('img/colorcorp-logo-small.png') }}" class="admin-icon" alt="Admin Logo"> -->
                        @else
