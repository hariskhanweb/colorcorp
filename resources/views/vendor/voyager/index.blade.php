                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card widget-flat card-box bg-secondary">
                            ...
                            <div class="p-3 pb-0">
                                ...
                                <h2 class="mt-2 text-white mb-0">0</h2>
                            </div>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card widget-flat card-box bg-primary">
                            ...
                            <div class="p-3 pb-0">
                                ...
                                <h4 class="text-white font-weight-normal mt-0">Total Products</h4>
                                <h2 class="mt-2 text-white mb-0">14</h2>
                            </div>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card widget-flat card-box bg-third">
                            ...
                            <div class="p-3 pb-0">
                                ...
                                <h4 class="text-white font-weight-normal mt-0">Total Users</h4>
                                <h2 class="mt-2 text-white mb-0">0</h2>
                            </div>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="mb-0 font-weight-medium"><a href="javascript: void(0);">Name</a></p>
                                                </div>
                                                </td>
                                                <td>
                                                email@email.com
                                                ...
                                                <td>
                                                <a href="javascript:;" class="btn btn-danger waves-effect waves-light delete-customer" data-id="12">
                                                    Delete
                                                </a>
                                                </td>
                                            </tr>
    ...
    datasets: [
        {
            ...
            borderWidth: 0,
            data: [4, 7, 3, 6, 10,7,4,6,4,6,9,7],
        },
        {
            label: "Products",
            backgroundColor: "#40513B",
            borderWidth: 0,
            data: [10,7,4,6,9,7,3,10,3,10,7,4],
        },
        {
            label: "Orders",
            backgroundColor: "#9DC08B",
            borderWidth: 0,
            data: [6,9,7,3,10,7,4,6, 10,7,4,6],
        },
    ],
  };
