...
<div class="bread-header"> 
    ...
    @endif 
    <form method="POST" action="{{ route('shopSetting.create') }}" enctype="multipart/form-data" class="form-horizontal">
        {{ csrf_field() }}
            ...
            <div class="col-lg-10">
                <div class="input-group">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="shop_logo" name="shop_logo" accept="image/png, image/jpg, image/jpeg" required>
        ...
        <div class="form-group row mb-0">
            ...
            <div class="col-lg-10">
                <div class="input-group">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="shop_banner" name="shop_banner" accept="image/png, image/jpg, image/jpeg" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="email" id="shop_email" name="shop_email" class="form-control" placeholder="Email">
            </div>
            <div class="col-lg-12">
                @error('shop_email')
                    <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" id="shop_mobile" name="shop_mobile" value="">
            </div>
            <div class="col-lg-12">
                @error('shop_mobile')
                    <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="number" class="form-control" id="shop_url_slug" name="shop_url_slug" value="">
            </div>
            <div class="col-lg-12">
                @error('shop_url_slug')
                    <span class="invalid-feedback" role="alert">
